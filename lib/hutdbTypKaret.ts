...
const RADKY: HutDbTypKarty[] = [
  ...
  {
    hodnotaFiltru: "HUT FINISH LINE",
    jmenoCs: "HUT Finish Line",
    popisCs: "Řada HUT Finish Line (NHL 26) — ikona z HUTDB / NHL HUT Builder.",
    comboSoubor: "FIN1440590888.png",
  },
  {
  ...
  {
    hodnotaFiltru: "NHL DRAFT 26",
    jmenoCs: "NHL Draft 26",
    popisCs: "Řada NHL Draft 26 (NHL HUT Builder Combo Finder).",
    comboSoubor: "DRAF1045649830.png",
  },
  {
